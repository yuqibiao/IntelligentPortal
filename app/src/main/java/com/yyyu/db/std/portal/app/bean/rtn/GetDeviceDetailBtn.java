 ...
 * @date 2022-12-01
 */
public class GetDeviceDetailBtn {
    ...
    public static class DataBean {
        ...
        private Object mac;
        private String deviceRuntimeStatus;
        ...
        public String getDeviceRuntimeStatus() {
            return deviceRuntimeStatus;
        }

        public void setDeviceRuntimeStatus(String deviceRuntimeStatus) {
            this.deviceRuntimeStatus = deviceRuntimeStatus;
        }
